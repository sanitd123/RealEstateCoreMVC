...
namespace RealEstateCoreMVC.Utilities
{
    public class DBConnect
    {
        ...
        string SqlConnectString = "server=cis-mssql1.temple.edu;Database=FA24_3342_tui96569;User id=tui96569;Password=eeJ9aef3faez;TrustServerCertificate=true";

        // Home Connection String - used for working from home using SSH Tunneling.
        //  String SqlConnectString = "server=127.0.0.1,5555;Database=FA24_3342_tui96569;User id=tui96569;Password=eeJ9aef3faez;TrustServerCertificate=true";
